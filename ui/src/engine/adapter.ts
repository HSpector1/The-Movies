...
export function importSaveJson(json: string): ImportOutcome {
  try {
    ...
    return { ok: true, state: migrateToV28(save).state, converted }
  } catch (e) {
    return { ok: false, error: (e as Error).message }
  }
}
...
export function importLegacyV2SaveJson(json: string): ImportOutcome {
  try {
    return {
      ok: true,
      state: migrateToV28(convertV17ToV18(convertV16ToV17(convertV15ToV16(convertV14ToV15(convertV13ToV14(convertV12ToV13(convertV11ToV12(convertV10ToV11(convertV9ToV10(convertV8ToV9(convertV7ToV8(convertV6ToV7(convertV5ToV6(convertV4ToV5(importLegacyV2ToV4(json)))))))))))))))).state,
      converted: true,
    }
  } catch (e) {
    return { ok: false, error: (e as Error).message }
...
export function importLegacyV1SaveJson(json: string): ImportOutcome {
  try {
    return {
      ok: true,
      state: migrateToV28(convertV17ToV18(convertV16ToV17(convertV15ToV16(convertV14ToV15(convertV13ToV14(convertV12ToV13(convertV11ToV12(convertV10ToV11(convertV9ToV10(convertV8ToV9(convertV7ToV8(convertV6ToV7(convertV5ToV6(convertV4ToV5(importLegacyV1ToV4(json)))))))))))))))).state,
      converted: true,
    }
  } catch (e) {
    return { ok: false, error: (e as Error).message }

...
![Matched hybrid and closer-to-original right rails](previews/08-right-rail-options.png)
...
![Reference, Backlot and proposed stage images](previews/09-source-backlot-proposed.png)
...
![Early studio](previews/02-early.png)
![Selected exact picture and local action](previews/03-selected.png)
![Waiting film and real contextual route](previews/04-waiting.png)
![Busy studio list at a nonzero offset](previews/05-busy.png)
![Small window and enlarged text with a long picture title](previews/06-small-enlarged.png)

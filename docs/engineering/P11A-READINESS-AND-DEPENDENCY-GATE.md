...
| Actual model, client, effective Max effort and runtime/review access | VERIFIED AND AUTHORIZED: actual root gpt-6-astra / ultra; Owner explicitly authorized this setting with “Yes continue” after mismatch disclosure. Saved max configuration unchanged. CLI 0.153.4, desktop 26.818.61809, Unity 6000.3.22f1, native capture, Accessibility/Input Monitoring and separate-review access verified. See execution log. |

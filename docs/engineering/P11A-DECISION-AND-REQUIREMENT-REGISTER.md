...
| `P11-REQ-029` | Add known-flow Upcoming from scheduled facts only | Product design `§23, §29.3, §38` @ `d6c38546d19fbb23533af496e0f62b9c340b7ce5` | **IMPLEMENT AS READY EXTENSION** | Final P08/P09/P10 dated facts | No speculative-hit rows | ALLOWED rows: facility `completesWeek`/Opex, contract end/renewal weeks, aggregate next-week and remaining projected Studio Revenue; per-week receipts BLOCKED pending disclosure decision | IMPLEMENTED-UNPROVEN | Producer3260aed/native product033e46b implemented; focused producer182, native1045 and first integrated S6 input pass. Owning contract-term remedy now passes1047 EditMode. Material/scale/P3/final Gate B pending; see execution log for exact evidence and later product qualifications. |
| `P11-REQ-030` | Add 13/52-week cash/cost charts with text equivalents | Product design `§30, §38` @ `d6c38546d19fbb23533af496e0f62b9c340b7ce5` | **IMPLEMENT AS READY EXTENSION** | Complete recorded history/query performance | Chart/table parity | ledger complete after boundary; bounded query NEW | IMPLEMENTED-UNPROVEN | Producer3260aed/native product033e46b implemented; focused producer182, native1045 and first integrated S6 input pass. Owning contract-term remedy now passes1047 EditMode. Material/scale/P3/final Gate B pending; see execution log for exact evidence and later product qualifications. |
...
| `P11-REQ-032` | Extend consequence preview to hire, renew, release and Greenlight | Product design `§24, §38` @ `d6c38546d19fbb23533af496e0f62b9c340b7ce5` | **IMPLEMENT AS READY EXTENSION** | Final P10/P04/P07 quote owners | Per-action stale/refusal proof | renew/release producers EXIST (`bridge/contract.ts`, real-input proven); hire via `signContract` quote; Greenlight via casting intents — REUSED producers | IMPLEMENTED-UNPROVEN | Producer3260aed/native product033e46b implemented; focused producer182, native1045 and first integrated S6 input pass. Owning contract-term remedy now passes1047 EditMode. Material/scale/P3/final Gate B pending; see execution log for exact evidence and later product qualifications. |
| `P11-REQ-033` | Build fuller portfolio filters and film/run deep links | Product design `§22, §29.3, §38` @ `d6c38546d19fbb23533af496e0f62b9c340b7ce5` | **IMPLEMENT AS READY EXTENSION** | P07/P08 histories | N-film performance/identity | P07 results + P08 film rows + `OpenReleaseResult` — REUSED | IMPLEMENTED-UNPROVEN | Producer3260aed/native product033e46b implemented; focused producer182, native1045 and first integrated S6 input pass. Owning contract-term remedy now passes1047 EditMode. Material/scale/P3/final Gate B pending; see execution log for exact evidence and later product qualifications. |

...
## CURRENT RESUME — read this first (updated 2026-09-25 21:53 CEST; supersedes every "Current …" section below)
...
- **Step now:** C.4 T0. Measure the fixture prerequisites and mint genuine outgoing V34 worlds (with lifecycle records) at the current writer BEFORE any C.4 source change; then the throwing scaffold, independent RED, sole writer, the 6,240-week demonstration with and without cohorts, review, matched pass.
...
- **Queued test-engineering task (coverage debt, record 788):** a lawful premise for `p14b5-relationships` family 6 that keeps its D5 requirement; an `approved_behavioral_change` entry for the `bridge-p14b5-relationships` seed-b ledger (48 → 47).

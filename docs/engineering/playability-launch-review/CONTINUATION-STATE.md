...
- Genuinely unresolved product questions: (1) retirement × open promise, VOIDED vs WAIVED (773 §7; recommendation A; only C.2c waits); (2) Scientist retirement window (none invented); (3) F-792-1, rival insolvency in 5 of 6 passive seeds (792 §2), an input to P15's scope check; (4) every C.2/C.4 number is PROVISIONAL TUNING, and every new C.2b sentence is CANDIDATE wording.

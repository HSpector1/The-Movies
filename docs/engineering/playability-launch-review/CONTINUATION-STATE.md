...
## CURRENT RESUME — read this first (updated 2026-09-26 03:05 CEST; supersedes every "Current …" section below)
...
- **Step now:** C.2b T0: mint genuine outgoing V35 worlds at the final C.4 writer (780 §6.3 axes a–f) BEFORE any C.2b source change; then the throwing scaffold per 806, independent RED in an isolated worktree, sole writer, V36 sweep, source review, prediction, matched pass. In parallel: the carried coverage-debt repair (788's family 6 + seed-b ledger, C.4's `p14c2a` E1) in an isolated worktree.

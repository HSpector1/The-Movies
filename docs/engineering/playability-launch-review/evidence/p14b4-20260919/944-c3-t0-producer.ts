// 944: genuine outgoing Save37 / projection52 T0 producer. Parent owns execution.
...
const PRODUCER = 'docs/engineering/playability-launch-review/evidence/p14b4-20260919/944-c3-t0-producer.ts'
...
assert.equal(saveBytes(session.gameState), currentSaveJson, 'public advance and continuous tick agree')

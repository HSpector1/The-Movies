...
- [~] **S8-T2 Engine increment** (sim-core dispatched ≈02:00 on `1a79a37`): V27, rival admission/research/hiring, movement kinds, receipts, validator, `StudioContext`, the per-studio chain check; sweep 26→27 (the six literal classes + rosters/bounds; frozen builders; roster-wall harness); evidence `08-engine-*`.

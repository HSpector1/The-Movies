...
- [~] **S7-T2 Engine increment** (sim-core dispatched ≈22:50 on `8720202`): catalogue data, `technologyDisclosure.ts`; S7 files green; no save change (assert `LIVE_SAVE_VERSION`
  26 unchanged in the sweep); evidence `08-engine-*`.

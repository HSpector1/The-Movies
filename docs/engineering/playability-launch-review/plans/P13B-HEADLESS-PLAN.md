...
- [~] **S6-T1/T2 Engine increment** (sim-core, dispatched): component progress, cancel actions, receipts, once-only refund, retained assets, restoration jobs, validator, finance bucket, Save V26, frozen builders + roster-wall harness for the new leaves.

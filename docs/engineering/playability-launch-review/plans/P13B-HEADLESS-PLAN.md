...
- [~] **S8-T3 Bridge projection 41** (test-author dispatched 2026-09-18 ≈05:20 on `742fb1e`; sim-core brief staged): test 8 RED-first (`tests/bridge-p13b-s8-rivals.test.ts`, evidence `10`), then sim-core; pins 40 → 41.

...
- [~] **S8-T4 Matched pass, attribution, label, records, commit, push:** backlog S8 entry written (`59876c0`); matched pass launched on the T3-closed commit (runner `run-s8-matched-pass.sh`; evidence `20-RUN`/`20-test-core-*`/`21-test-bridge-*`); attribution against the inherited set (campaign-library ≤ 11, r3n1 6, campaign-isolation 1, scientist-foundation 3, scenery 1) then the label.

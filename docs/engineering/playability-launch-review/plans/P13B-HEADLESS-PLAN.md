...
- [~] **S6-T3 Bridge projection 39:** test 8 — test-author dispatched RED-first (`tests/bridge-p13b-s6-cancellation.test.ts`, evidence `10-bridge-cancellation-RED.txt`); sim-core brief staged.

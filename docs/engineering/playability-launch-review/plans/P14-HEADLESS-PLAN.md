...
- [~] **T1 Tests 1–8 RED-first** (test-author dispatched 2026-09-18 ≈06:50 on `cbdc9ea`): `tests/p14a1-{eligibility,case,proposals,rival-trigger,settlement,disclosure,firing,save-v28}.test.ts`; evidence `p14a1-20260918/01`–`08`. - [ ] **T2 Engine increment** (sim-core; V28; sweep 27→28 incl. rosters/bounds).

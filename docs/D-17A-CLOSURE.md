...
| T6 | Quantified discoverability exposure | Same-rule read-model (proved identical to `resolveReception`'s rule over a 240-point sweep); shortfall-derived band; regime-gated; the retired proxy demonstrably mislabeled both adversarial shapes. **D-17B remeasurement:** production tuple `.375 / 4 / 1.5 / .30 / 1.8`; Week-86 band `.3×–1.8×`; the old A45/$2M fixture is now correctly supported and the committed A35/$2M replacement preserves the proxy-mismatch proof. See Owner Evidence §3.4/§7(b). |

...
3. Commit and push documentation/tooling as **D**, regenerate management v4 from **D**, update its exact Unity pin, then commit and push Unity as **U**; confirm both clean upstream identities. Do not edit either source tree afterward.

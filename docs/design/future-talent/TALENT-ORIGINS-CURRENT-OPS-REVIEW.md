...
```mermaid
flowchart LR
    P10[P10: PersonId, profile, craft, screen career] --> CAST[P04: audition and role Fit]
    P10 --> LIFE[P14: lifecycle, choices, cohorts]
    P12[P12: employer, exclusivity, intervals] --> AVAIL[availability decision]
    P13[P13: era and jurisdiction capability] --> ELIG[young-performer eligibility policy]

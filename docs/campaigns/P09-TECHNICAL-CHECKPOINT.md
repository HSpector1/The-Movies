...
| CF-09 `verify:bridge-contract-consumer --verify-only` | PASS at TS `fee206fa` × Unity `d3a22868` (`cf09-p09-w5.json`); PASS at TS `fee206fa` × Unity `a8f4c1aa` (`cf09-p09-w5b.json`); ⟨CF09_W6⟩ |

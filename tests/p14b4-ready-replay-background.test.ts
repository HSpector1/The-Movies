// Installed from independently frozen278 (type-only correction to268); original inert provenance below retained unchanged.
...
import type { CastingSlate, GameState, Production } from '../src/core/types.js'
...
describe('P14B4 Ready replay — exact diagnostics and independent audition work', () => {
  ...
  it('admits Ready A beside B’s genuine active audition, closes its resource-only background before sweep, and never engages audition candidates twice', () => {
    ...
    const slate: CastingSlate = { lead: [lead, antagonist], antagonist: [lead, support], support: [antagonist, support] }

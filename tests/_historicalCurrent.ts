import {migrateToV18,migrateToV28,type SaveFile,type SaveFileV28,type GameStateV18,type GameState} from '../src/core/index.js'
...
export function migrateToCurrentControl(save:SaveFile):SaveFileV28 {
  if(save.saveVersion>=19)return migrateToV28(save)
  const old=migrateToV18(save)
  return {...old,saveVersion:28,state:liftHistoricalState(old.state)}
}

...
import { applyActions, importSave, migrateToV31 } from '../src/core/index.js'
...
function state(store: Store): GameState { return migrateToV31(importSave(working(store).currentSaveJson)).state }

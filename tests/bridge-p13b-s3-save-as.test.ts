...
import { applyActions, importSave, migrateToV29 } from '../src/core/index.js'
...
function state(store: Store): GameState { return migrateToV29(importSave(working(store).currentSaveJson)).state }

...
import { applyActions, importSave, migrateToLive } from '../src/core/index.js'
...
function state(store: Store): GameState { return migrateToLive(importSave(working(store).currentSaveJson)).state }

...
import { applyActions, importSave, migrateToV27 } from '../src/core/index.js'
...
function state(store: Store): GameState { return migrateToV27(importSave(working(store).currentSaveJson)).state }

...
import { applyActions, importSave, migrateToV28 } from '../src/core/index.js'
...
function state(store: Store): GameState { return migrateToV28(importSave(working(store).currentSaveJson)).state }

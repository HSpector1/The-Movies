...
import { applyActions, importSave, migrateToV26 } from '../src/core/index.js'
...
function state(store: Store): GameState { return migrateToV26(importSave(working(store).currentSaveJson)).state }

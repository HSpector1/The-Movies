...
import { applyActions, importSave, migrateToV33 } from '../src/core/index.js'
...
function state(store: Store): GameState { return migrateToV33(importSave(working(store).currentSaveJson)).state }

...
import { applyActions, importSave, migrateToV32 } from '../src/core/index.js'
...
function state(store: Store): GameState { return migrateToV32(importSave(working(store).currentSaveJson)).state }

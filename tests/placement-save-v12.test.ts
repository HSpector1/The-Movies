...
describe('Placement Core V12 — the frozen envelope', () => {
  ...
  it('rejects overlapping placements and clearance-ring violations in a forged save', () => {
    ...
    expect(validateSaveV35(valid)).toBe(valid)
    ...
    expect(() => validateSaveV35(overlapped)).toThrow(/overlaps placed facility 1/)
    ...
    expect(() => validateSaveV35(tooClose)).toThrow(/violates its clearance ring/)
  })
  ...
  it('rejects a forged operating charge that disagrees with the operational facilities', () => {
    ...
    expect(() => validateSaveV35(doubled)).toThrow(
    ...
    expect(() => validateSaveV35(early)).toThrow(

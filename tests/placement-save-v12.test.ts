...
describe('Placement Core V12 — the frozen envelope', () => {
  ...
  it('rejects overlapping placements and clearance-ring violations in a forged save', () => {
    ...
    expect(validateSaveV33(valid)).toBe(valid)
    ...
    expect(() => validateSaveV33(overlapped)).toThrow(/overlaps placed facility 1/)
    ...
    expect(() => validateSaveV33(tooClose)).toThrow(/violates its clearance ring/)
  })
  ...
  it('rejects a forged operating charge that disagrees with the operational facilities', () => {
    ...
    expect(() => validateSaveV33(doubled)).toThrow(
    ...
    expect(() => validateSaveV33(early)).toThrow(

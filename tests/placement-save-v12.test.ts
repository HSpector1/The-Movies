...
describe('Placement Core V12 — the frozen envelope', () => {
  ...
  it('rejects overlapping placements and clearance-ring violations in a forged save', () => {
    ...
    expect(validateSaveV21(valid)).toBe(valid)
    ...
    expect(() => validateSaveV21(overlapped)).toThrow(/overlaps placed facility 1/)
    ...
    expect(() => validateSaveV21(tooClose)).toThrow(/violates its clearance ring/)
  })
  ...
  it('rejects a forged operating charge that disagrees with the operational facilities', () => {
    ...
    expect(() => validateSaveV21(doubled)).toThrow(
    ...
    expect(() => validateSaveV21(early)).toThrow(

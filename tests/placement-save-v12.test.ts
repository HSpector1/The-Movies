...
describe('Placement Core V12 — the frozen envelope', () => {
  ...
  it('rejects overlapping placements and clearance-ring violations in a forged save', () => {
    ...
    expect(validateSaveV34(valid)).toBe(valid)
    ...
    expect(() => validateSaveV34(overlapped)).toThrow(/overlaps placed facility 1/)
    ...
    expect(() => validateSaveV34(tooClose)).toThrow(/violates its clearance ring/)
  })
  ...
  it('rejects a forged operating charge that disagrees with the operational facilities', () => {
    ...
    expect(() => validateSaveV34(doubled)).toThrow(
    ...
    expect(() => validateSaveV34(early)).toThrow(

...
describe('Placement Core V12 — the frozen envelope', () => {
  ...
  it('rejects overlapping placements and clearance-ring violations in a forged save', () => {
    ...
    expect(validateSaveV26(valid)).toBe(valid)
    ...
    expect(() => validateSaveV26(overlapped)).toThrow(/overlaps placed facility 1/)
    ...
    expect(() => validateSaveV26(tooClose)).toThrow(/violates its clearance ring/)
  })
  ...
  it('rejects a forged operating charge that disagrees with the operational facilities', () => {
    ...
    expect(() => validateSaveV26(doubled)).toThrow(
    ...
    expect(() => validateSaveV26(early)).toThrow(

...
describe('Placement Core V12 — the frozen envelope', () => {
  ...
  it('rejects overlapping placements and clearance-ring violations in a forged save', () => {
    ...
    expect(validateSaveV28(valid)).toBe(valid)
    ...
    expect(() => validateSaveV28(overlapped)).toThrow(/overlaps placed facility 1/)
    ...
    expect(() => validateSaveV28(tooClose)).toThrow(/violates its clearance ring/)
  })
  ...
  it('rejects a forged operating charge that disagrees with the operational facilities', () => {
    ...
    expect(() => validateSaveV28(doubled)).toThrow(
    ...
    expect(() => validateSaveV28(early)).toThrow(

...
describe('Placement Core V12 — the frozen envelope', () => {
  ...
  it('rejects overlapping placements and clearance-ring violations in a forged save', () => {
    ...
    expect(validateSaveV24(valid)).toBe(valid)
    ...
    expect(() => validateSaveV24(overlapped)).toThrow(/overlaps placed facility 1/)
    ...
    expect(() => validateSaveV24(tooClose)).toThrow(/violates its clearance ring/)
  })
  ...
  it('rejects a forged operating charge that disagrees with the operational facilities', () => {
    ...
    expect(() => validateSaveV24(doubled)).toThrow(
    ...
    expect(() => validateSaveV24(early)).toThrow(

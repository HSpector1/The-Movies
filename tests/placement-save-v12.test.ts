...
describe('Placement Core V12 — the frozen envelope', () => {
  ...
  it('rejects overlapping placements and clearance-ring violations in a forged save', () => {
    ...
    expect(validateSaveV25(valid)).toBe(valid)
    ...
    expect(() => validateSaveV25(overlapped)).toThrow(/overlaps placed facility 1/)
    ...
    expect(() => validateSaveV25(tooClose)).toThrow(/violates its clearance ring/)
  })
  ...
  it('rejects a forged operating charge that disagrees with the operational facilities', () => {
    ...
    expect(() => validateSaveV25(doubled)).toThrow(
    ...
    expect(() => validateSaveV25(early)).toThrow(

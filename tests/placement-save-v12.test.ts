...
describe('Placement Core V12 — the frozen envelope', () => {
  ...
  it('rejects overlapping placements and clearance-ring violations in a forged save', () => {
    ...
    expect(validateSaveV27(valid)).toBe(valid)
    ...
    expect(() => validateSaveV27(overlapped)).toThrow(/overlaps placed facility 1/)
    ...
    expect(() => validateSaveV27(tooClose)).toThrow(/violates its clearance ring/)
  })
  ...
  it('rejects a forged operating charge that disagrees with the operational facilities', () => {
    ...
    expect(() => validateSaveV27(doubled)).toThrow(
    ...
    expect(() => validateSaveV27(early)).toThrow(

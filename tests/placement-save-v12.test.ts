...
describe('Placement Core V12 — the frozen envelope', () => {
  ...
  it('rejects overlapping placements and clearance-ring violations in a forged save', () => {
    ...
    expect(validateSaveV22(valid)).toBe(valid)
    ...
    expect(() => validateSaveV22(overlapped)).toThrow(/overlaps placed facility 1/)
    ...
    expect(() => validateSaveV22(tooClose)).toThrow(/violates its clearance ring/)
  })
  ...
  it('rejects a forged operating charge that disagrees with the operational facilities', () => {
    ...
    expect(() => validateSaveV22(doubled)).toThrow(
    ...
    expect(() => validateSaveV22(early)).toThrow(

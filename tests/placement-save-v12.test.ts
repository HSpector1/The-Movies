...
describe('Placement Core V12 — the frozen envelope', () => {
  ...
  it('rejects overlapping placements and clearance-ring violations in a forged save', () => {
    ...
    expect(validateSaveV23(valid)).toBe(valid)
    ...
    expect(() => validateSaveV23(overlapped)).toThrow(/overlaps placed facility 1/)
    ...
    expect(() => validateSaveV23(tooClose)).toThrow(/violates its clearance ring/)
  })
  ...
  it('rejects a forged operating charge that disagrees with the operational facilities', () => {
    ...
    expect(() => validateSaveV23(doubled)).toThrow(
    ...
    expect(() => validateSaveV23(early)).toThrow(

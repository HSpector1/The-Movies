...
describe('Placement Core V12 — the frozen envelope', () => {
  ...
  it('rejects overlapping placements and clearance-ring violations in a forged save', () => {
    ...
    expect(validateSaveV30(valid)).toBe(valid)
    ...
    expect(() => validateSaveV30(overlapped)).toThrow(/overlaps placed facility 1/)
    ...
    expect(() => validateSaveV30(tooClose)).toThrow(/violates its clearance ring/)
  })
  ...
  it('rejects a forged operating charge that disagrees with the operational facilities', () => {
    ...
    expect(() => validateSaveV30(doubled)).toThrow(
    ...
    expect(() => validateSaveV30(early)).toThrow(

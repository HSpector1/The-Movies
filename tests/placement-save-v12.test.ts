...
describe('Placement Core V12 — the frozen envelope', () => {
  ...
  it('rejects overlapping placements and clearance-ring violations in a forged save', () => {
    ...
    expect(validateSaveV31(valid)).toBe(valid)
    ...
    expect(() => validateSaveV31(overlapped)).toThrow(/overlaps placed facility 1/)
    ...
    expect(() => validateSaveV31(tooClose)).toThrow(/violates its clearance ring/)
  })
  ...
  it('rejects a forged operating charge that disagrees with the operational facilities', () => {
    ...
    expect(() => validateSaveV31(doubled)).toThrow(
    ...
    expect(() => validateSaveV31(early)).toThrow(

...
import { convertV19ToV20, exportSave, importSave, makeSave, makeSaveV18, migrateToV19, migrateToV20, migrateToV30, validateSaveV19, validateSaveV20 } from '../src/core/save.js'
...
describe('P13A governed V19 to V20 persistence', () => {
  ...
  it('validates the source before JSON detachment can erase an invalid leaf', () => {
    const save = migrateToV30(accepted())

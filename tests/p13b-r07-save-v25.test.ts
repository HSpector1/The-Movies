...
describe('P13B-S5-R07 Save V25 (test 5)', () => {
  ...
  // "an unknown saveVersion 33..." case, kept here rather than deleted).
  it('an unknown saveVersion 33 is refused, naming the handled range "1 through 32 only" (B4 additive reader boundary)', () => {
    const forged = { ...save.makeSave(legacyRehearsingWorld('r07-save-v25-unknown-version')), saveVersion: 33 }

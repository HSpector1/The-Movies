...
import { generateWorld,tick,makeSave,exportSave,importSave,migrateToV29 } from '../src/core/index.js'
...
describe('R05 shared-law rival lifecycle',()=>{
  ...
  it('commissions, staffs, funds, operates, releases and settles real films without player RNG draws',()=>{
    ...
    const reloaded=migrateToV29(importSave(exportSave(makeSave(state)))).state

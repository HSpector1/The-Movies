...
import { beginFounding, generateWorld, makeSave, exportSave, importSave, migrateToV25, migrateToV29, makeSaveV18 } from '../src/core/index.js'
...
describe('R05 canonical starting history and genuine migration', () => {
  it('opens four established distinct businesses with settled canonical history and protected applicants', () => {
    ...
    expect(exportSave(migrateToV29(importSave(bytes)))).toBe(bytes)

...
describe('CF-08 sound union-to-C# generation', () => {
  ...
  describe('current accepted contract and future sentinel', () => {
    it('F10 emits sound request and response union shapes without changing schema identity', () => {
      ...
      expect(generated).toContain(
        '// Schema identity: sha256:8b2569b1f925bedf214ee556841fe28b61e544f1f13bb4741c84a0a318e81a85',
      )
    ...
    it('pins exact positive output identities and deterministic rerendering', () => {
      const expected = {
        ...
        F10_CURRENT_QUOTE_UNIONS: 'a359a8d207216ecb56f490101ef8e80a5c33d604d95318fc3a0730cceb59b88f',
        F11_CURRENT_COMMAND_UNION: 'a359a8d207216ecb56f490101ef8e80a5c33d604d95318fc3a0730cceb59b88f',

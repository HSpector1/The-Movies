...
export function poachingFixture() {
  ...
  let state = advanceTo(fund(p13aGeneratedStudio('p13-public-commercial-adoption')), 196)
  ...
  validateSaveV29(JSON.parse(JSON.stringify(makeSave(outcome))))

...
describe('P13B-S2 T6 Laboratory bridge page: projection bump', () => {
  it('bumps PROJECTION_VERSION to the S2 wire contract (34; 36 after the S4-T3 bump)', () => {
    expect(PROJECTION_VERSION).toBe(36)
  })
})

describe('case 1: a fresh Laboratory publishes snapshotVersion 36 and an empty projects array', () => {

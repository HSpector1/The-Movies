...
import type { SaveFileV28, SaveFileV29, SaveFileV30, SaveFileV31 } from '../../core/save.js'
 ...
 */
function emit(file: string, save: SaveFileV28 | SaveFileV29 | SaveFileV30 | SaveFileV31, week: number): void {

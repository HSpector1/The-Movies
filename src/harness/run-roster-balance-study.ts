...
const ROSTER_PLAN: Record<Strategy, Record<CreativeRole, number>> = {
  lean: { actor: 3, director: 1, writer: 1, craft: 1, scientist: 0 }, // the legal minimum (D-11.D: 1 writer)
  balanced: { actor: 7, director: 2, writer: 3, craft: 2, scientist: 0 },
  star: { actor: 6, director: 2, writer: 2, craft: 1, scientist: 0 },
  fireAll: { actor: 3, director: 1, writer: 1, craft: 1, scientist: 0 }, // founds the minimum, then fires
}

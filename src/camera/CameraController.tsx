...
const PRESETS: Record<SceneKey, Record<CameraMode, Preset>> = {
  ...
  G: { overview: { pos: [22, 13, 30], tgt: [0, 3, 4] }, inspection: { pos: [2, 2.2, 18], tgt: [0, 1.4, 8] } },
}
...
export function CameraController(): null {
  ...
  }, [state.scene, state.cameraMode, state.gReview, state.cameraResetNonce, camera, controls])
  return null
}

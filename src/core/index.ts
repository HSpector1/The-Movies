...
export {
  ...
  migrateToV24,
  convertV23ToV24,
  // P13B-S6 — V25 → V26 + migrateToV26 (the widened cancellation leaves).
  validateSaveV26,
  migrateToV26,
  convertV25ToV26,
  // P13B-S8 — live V26 → NEW V27 + migrateToV27 (the rival research movements and receipts).
  validateSaveV27,
  migrateToV27,
  convertV26ToV27,
  convertV27ToV26,

...
function greenlightQuoteSnapshot(
  ...
  return {
    ...
    negative,
    marketing,
    freelancerFees: Math.round(freelancerFees),
    totalImmediate: Math.round(totalImmediate),
    cashBefore: Math.round(cashBefore),
    cashAfter: cashAfter === null ? null : Math.round(cashAfter),
    affordable,
